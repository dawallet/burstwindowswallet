...
import pocminer_pool.ScoopReader;
import pocminer_pool.ScoopChecker;
import pocminer_pool.PoolScoopChecker;
...
public class Miner extends UntypedActor {
	...
	public void onReceive(Object message) throws Exception {
		if(message instanceof ScoopReader.msgScoopChunk) {
			if(passPhrases.containsKey(((ScoopReader.msgScoopChunk)message).address)) {
