...
import pocminer_pool.GenerateSupr;
...
public class POCMiner {
	...
	public static void main(String[] args) {
		if(args.length < 1) {
			...
			System.out.println("pocminer mine http://ip:port http://poolip:port");
	...
	private static void startMining(String addr, String poolAddr) {
		ActorSystem system = ActorSystem.create();
		ActorRef minesupr = system.actorOf(Props.create(MinerSupr.class, addr, poolAddr));
	}
